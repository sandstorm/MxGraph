...
var DiagramEditor = (_dec = (0, _reactRedux.connect)(function (state) {
    ...
    render() {
        ...
        var importDiagram = function importDiagram() {
            ...
            input.onchange = function (_) {
                ...
                var isDrawioFile = files[0].name.endsWith(".drawio");
                if (isDrawioFile) {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { style: 'brand', onClick: clickButton },
                    'Open Diagram Editor'
                )
            ),
            _react2.default.createElement(
...
var _DiagramEditor = __webpack_require__(/*! ./DiagramEditor */ "./src/DiagramEditor.js");
